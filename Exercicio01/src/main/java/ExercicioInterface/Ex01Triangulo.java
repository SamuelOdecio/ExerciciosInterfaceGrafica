 ...
 * @author 07076063140
 */
public class Ex01Triangulo extends javax.swing.JFrame {

    /**
     * Creates new form Ex01
     */
    public Ex01Triangulo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ex01Triangulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ex01Triangulo().setVisible(true);
            }
        });
    }
